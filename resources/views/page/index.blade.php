...
<body class="min-h-screen bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100">
        ...
        <nav class="mx-auto flex h-full max-w-screen-xl items-center justify-between px-4 sm:px-5 md:px-6">
            ...
            <div class="hidden items-center gap-2 md:flex">
                <a href="{{ route('pengaduan.create') }}"
                    class="inline-flex items-center justify-center rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-blue-700 shadow-sm transition hover:bg-blue-50 focus:outline-none focus-visible:ring focus-visible:ring-white/50">Buat
                    Pengaduan</a>
                <a href="{{ route('pengaduan.track') }}"
                    class="inline-flex items-center justify-center rounded-2xl border border-white/70 bg-transparent px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-white/10 focus:outline-none focus-visible:ring focus-visible:ring-white/40">Lacak
                    Pengaduan</a>
            </div>

            <!-- Mobile Toggle -->
            <button aria-label="Buka menu" aria-expanded="false" aria-controls="mobile-menu" data-toggle="mobile-menu"
                class="inline-flex items-center gap-2 rounded-xl border border-white/40 bg-white/10 p-2 text-sm md:hidden focus:outline-none focus-visible:ring focus-visible:ring-white/50">
                <!-- Icon will inherit currentColor from text -->
    ...
    <!-- HERO -->
    <section class="relative overflow-hidden py-5 sm:py-6 md:py-6">
    ...
    <!-- FOOTER -->
    <footer class="mt-4 border-t ">
        <div
            class="mx-auto max-w-7xl px-4 sm:px-6 py-4 flex flex-col md:flex-row items-center justify-between text-sm text-gray-600 dark:text-gray-300 gap-2">
            <p class="font-semibold text-gray-700 dark:text-gray-200">SANDI JABAR — Sarana Pengaduan Imigrasi Jawa Barat
            </p>
            <p class="text-xs text-gray-500 dark:text-gray-400">© {{ date('Y') }} Kantor Wilayah Direktorat Jenderal
                Imigrasi Jawa
                Barat</p>
        </div>
    </footer>
