<x-layout :title="$title ?? 'Manajemen Pengguna — Admin UPT'">
        ...
        <div class="rounded-2xl overflow-hidden shadow-sm border border-slate-200 bg-white">
            <div class="px-6 py-5 bg-linear-to-r from-indigo-600 to-sky-500 text-white">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        <h1 class="text-lg font-semibold">Manajemen Pengguna — Admin UPT</h1>
                        <p class="text-xs text-indigo-100/90">Kelola akun admin UPT di lingkungan Kantor Wilayah
                            Direktorat Jenderal Imigrasi Jawa Barat.</p>
                    </div>

                    <a href="/kanwil/users/admin-upt/tambah"
            ...
            <div class="px-6 py-4 border-b border-slate-200 bg-white">
                ...
                <x-kanwil.users.admin.table :users="$users" />
            </div>
