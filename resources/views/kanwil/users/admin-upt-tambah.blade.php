<x-layout :title="$title ?? 'Tambah Pengguna — Admin UPT'">
            ...
            <form method="POST" action="{{ route('kanwil.users.admin-upt.store') }}" class="px-6 py-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                      ...
                      @error('name') border-rose-400 focus:border-rose-500 focus:ring-rose-500
                ...
                <div>
                    ...
                    <input type="text" name="nip" value="{{ old('nip') }}"
                        class="w-full mt-1 rounded-lg border px-3 py-2 text-sm 
                      @error('nip') border-rose-400 focus:border-rose-500 focus:ring-rose-500
                      @else border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 @enderror"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}"
                        class="w-full mt-1 rounded-lg border px-3 py-2 text-sm 
                      @error('email') border-rose-400 focus:border-rose-500 focus:ring-rose-500
                      @else border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 @enderror"
                ...
                <div class="flex items-center justify-end gap-2 pt-4 border-t border-slate-200">
                    ...
                    <button type="submit"
                        class=" cursor-pointer inline-flex items-center gap-2 px-5 py-2 rounded-lg text-white font-medium
